...
void AdvMuFilter::ConstructGeometry()
{
	...
	*/
    ...
    TGeoVolumeAssembly *volAdvMuFilter  = new TGeoVolumeAssembly("volAdvMuFilter");
    //detector->AddNode(volAdvMuFilter,0,new TGeoTranslation(-2.4244059999999976,0,0));
    ...
    detector->AddNode(volAdvMuFilter,0,new TGeoTranslation(-2.4244059999999976+2.45, 38.3, 354.862+3+1+fFeZ/2.));
